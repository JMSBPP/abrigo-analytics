...
- Track A spec (`scratch/2026-04-25-task110-rev2-spec-A-autonomous.md`, commit-pending) uses mean-β identification with HAC(4); reviewers must validate whether this is sufficient OR whether tail-risk extensions are required for product-validity.
